<template>
  <div class="w-1/2 py-24 px-24 my-24 mx-auto text-gray-800 shadow-md rounded">
    <img src="../assets/images/logo.png" alt="PAT Logo" class="logo mx-auto">
    <h2 class="text-center py-3">Welcome to PAT Learning Management System. <br> Don't have an account yet? <router-link :to="{name:'register'}" class="text-sky-600">Sign up</router-link></h2>
    <form>
          <!-- Email input -->
          <div class="mb-6">
            <input
