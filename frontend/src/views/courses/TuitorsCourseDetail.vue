<template>
    ...
    <button
        ...
        type="button" data-modal-toggle="defaultModal" @click="toogleSwitch">Add Lesson</button>

<div id="authentication-modal" tabindex="-1" aria-hidden="true" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full" :class="{ hidden: isOpen }">
    <div class="pt-32 mx-auto w-full max-w-md h-full md:h-auto">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="authentication-modal">
                ...
                <span class="sr-only" @click.once="toogleSwitch">Close modal</span>
            </button>
            <div class="py-6 px-6 lg:px-8">
                ...
                <form class="space-y-6" action="#">
                    <div>
                        ...
                        <input type="text" name="email" id="coursename" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="course name" required>
                    </div>
                    <div>
                        <label for="coursedisc" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">What will student learn</label>
                        <textarea name="" id="coursedisc" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"></textarea>
                    </div>
...
export default {
    setup() {
        ...
        return { course,isOpen, navigateTo,toogleSwitch}
    }
